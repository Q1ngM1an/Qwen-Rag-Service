...
class KnowledgeBaseService:
    ...
    def create_knowledge_base(self, name: str, description: str | None = None, owner_id: str | None = None):
        ...
        self.db.create_knowledge_base(kb_id, name, description, owner_id)
        return self.get_knowledge_base(kb_id)

    def list_knowledge_bases(self, search: str | None = None):
        return [self._serialize_knowledge_base(item) for item in self.db.list_knowledge_bases(search)]
    ...
    def list_files(self, kb_id: str, search: str | None = None):
        self.get_knowledge_base(kb_id)
        return [self._serialize_file(item) for item in self.db.list_knowledge_base_files(kb_id, search)]
    ...
    def _serialize_knowledge_base(self, knowledge_base: dict):
        return {
